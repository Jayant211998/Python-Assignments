...
def create_parking(n,o):
    global datastore
    if n == 0:
        return 0
    for i in range(1, n + 1):
        datastore["office"+str(o)]["parking" + str(i)] = datastore["office0"]["parking0"]

def create_medical(n,o):
    global datastore
    if n == 0:
        return 0
    for i in range(1, n + 1):
        datastore["office"+str(o)]["medical" + str(i)] = datastore["office0"]["medical0"]
...
def cnp():
        ...
        try:
            ...
            print("office dose not exist")
def cnm():
    print("Create new medical rooms")
    n = int(input("Enter number of medical to be created"))
    try:
        o = int(input("enter office number "))
        create_medical(n,o)
        print()
...
def do():
    try:
        o = int(input("enter office number to be deleted"))
        del datastore['office'+str(o)]
    except:
        print("Office do not Exist")
def dm():
    try:
        o = int(input("enter office number to be deleted"))
        m = int(input("enter medical room number to be deleted"))
        del datastore['office'+str(o)]['medical'+str(m)]
    except:
        print("Room do not Exist")
def dp():
    try:
        o = int(input("enter office number to be deleted"))
        p = int(input("enter medical room number to be deleted"))
        del datastore['office'+str(o)]['medical'+str(p)]
    except:
        print("Parking do not Exist")
...
while(True):
    ...
    print("8.SaveData")
    print("9. Exit")
    print("10. Remove Office")
    print("11. Remove Medical Room")
    print("12. Remove Parking")
